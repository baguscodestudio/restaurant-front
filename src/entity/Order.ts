...
export default class Order {
  ...
  public async fetchOrders() {
    return await axios
      .get(`${import.meta.env.VITE_REST_URL}/order/`)
  ...
  public async fetchOrderTable() {
    return await axios
      .get(`${import.meta.env.VITE_REST_URL}/order/${this.tablenum}`)
      .then((response) => response)
      .catch((err) => err);
  }
  ...
  public async fetchCompletedOrders() {
    return await axios
      .get(`${import.meta.env.VITE_REST_URL}/order/completedOrders`)
      .then((response) => response)
      .catch((err) => err);
  }
  ...
  public async searchOrder(query: string) {
    return await axios
      .post(`${import.meta.env.VITE_REST_URL}/order/search`, {
        query: query,
      })
      .then((response) => response)
      .catch((err) => err);
  ...
  public async createOrder() {
    return await axios
      .post(`${import.meta.env.VITE_REST_URL}/order/`, {
  ...
  public async markOrder(order: OrderType, email: string) {
    return await axios
      .post(`${import.meta.env.VITE_REST_URL}/order/complete/${this.orderid}`, {
        order: order,
        email: email,
      })
      .then((response) => response)
  ...
  public async updateOrder(orderid: number, price: number, items: OrderItem[]) {
    return await axios
      .put(`${import.meta.env.VITE_REST_URL}/order/${orderid}`, {
        price: price,
        items: items,
      })
      .then((response) => response)
  ...
  public async deleteOrder(orderid: number) {
    return await axios
      .delete(`${import.meta.env.VITE_REST_URL}/order/${orderid}`)
      .then((response) => response)
      .catch((err) => err);
  }
}
